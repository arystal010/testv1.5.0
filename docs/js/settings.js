...
// ============================================================
// FIX: initSettings was called by app.js but never defined/exported
// ============================================================
export function initSettings() {
    // No-op initializer — settings are loaded lazily via getSettings().
    // This exists so app.js can call initSettings() safely on startup.
}
