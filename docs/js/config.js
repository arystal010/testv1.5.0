...
export const CONFIG = {
    // API
    // IMPORTANT: Set this to your deployed Cloudflare Worker URL, e.g.:
    // "https://arysaiwebsite.<your-account>.workers.dev"
    // A relative "/api" won't work because docs/ is hosted on GitHub Pages,
    // which is a different origin from the Cloudflare Worker.
    apiBase: "https://arysaiwebsite.workers.dev",
